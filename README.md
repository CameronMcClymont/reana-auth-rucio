...
additional logic or libraries, just the bare minimum to support Rucio. The image
...
`reana-auth-rucio` was developed for use in the [REANA](http://www.reana.io/)
reusable research data analysis platform.

## Usage

You can use `reana-auth-rucio` as a base image, however it was built to be used
as a sidecar container with the single purpose of creating the right Rucio
